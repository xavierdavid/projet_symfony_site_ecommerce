...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\PasswordStrength([
        ...
        'message' => 'Votre mot de passe est trop facile à deviner. Veuillez utiliser un mot de passe plus fort.'
    ])]
    ...
    /**
     * Retourne l'identifiant de l'utilisateur sous forme d'une chaîne de caractères
     *
     * @return string
     */
